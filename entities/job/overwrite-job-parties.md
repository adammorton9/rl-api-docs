...
<mark style="color:orange;">`PUT`</mark> `https://ris.rightsline.com/v4/job/:id/overwrite-parties`

This endpoint allows you to overwrite parties for a specific job by ID.

#### Path Parameters

| Name                                 | Type   | Description    |
| ------------------------------------ | ------ | -------------- |
| id<mark style="color:red;">\*</mark> | number | ID of the job. |
...
{% tab title="404: Not Found Could not find a job with this ID." %}
```javascript
{
...
{% tab title="404: Not Found Selected parties not found on job." %}
```json
...
{% tab title="404: Not Found No parties exist on job." %}
```json
{
