---
description: Switches the job record to a new template
---
...
<mark style="color:green;">`POST`</mark> `https://ris.rightsline.com/v4/job/:id/switch-template`

This endpoint allows you to change the template of an job.

#### Path Parameters

| Name                                 | Type   | Description                              |
| ------------------------------------ | ------ | ---------------------------------------- |
| id<mark style="color:red;">\*</mark> | string | ID of the job to switch the template of. |
...
<mark style="color:green;">`POST`</mark> `https://ris.rightsline.com/v4/job/:id/switch-template-check`
...
| Name | Type   | Description                              |
| ---- | ------ | ---------------------------------------- |
| id   | string | ID of the job to switch the template of. |
