...
<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/job/:id/validation-errors`

This endpoint allows you to retrieve validation errors for a specific job by ID.

#### Path Parameters

| Name                                 | Type   | Description                                  |
| ------------------------------------ | ------ | -------------------------------------------- |
| id<mark style="color:red;">\*</mark> | string | ID of the job to retrieve validation errors. |
...
{% tab title="404: Not Found Could not find an job with this ID." %}
```javascript
{
