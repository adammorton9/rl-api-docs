...
## Get right draft templates

<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/right/:id/draft-templates`

This endpoint allows you to get the draft templates for a right.

#### Path Parameters

| Name | Type   | Description      |
| ---- | ------ | ---------------- |
| id   | string | ID of the right. |
