...
## Get right validation errors

<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/right/:id/validation-errors`

This endpoint allows you to retrieve validation errors for a specific right by ID.

#### Path Parameters

| Name                                 | Type   | Description                                    |
| ------------------------------------ | ------ | ---------------------------------------------- |
| id<mark style="color:red;">\*</mark> | string | ID of the right to retrieve validation errors. |
...
{% tab title="404: Not Found Could not find an right with this ID." %}
```javascript
{
