---
description: Retrieve the audit history for a right record.
---
...
<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/right/:id/audit-history`

This endpoint allows you to retrieve the audit history of a specific right by ID.
...
<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/right/:id/audit-history-detail`
...
{% tabs %}
{% tab title="200 Right history details retrieved successfully." %}
```javascript
{
    "changedField": "notes",
    "oldValue": "old note",
