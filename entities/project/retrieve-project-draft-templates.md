...
## Get project draft templates

<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/project/:id/draft-templates`

This endpoint allows you to get the draft templates for a project.
