...
## Get project validation errors

<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/project/:id/validation-errors`

This endpoint allows you to retrieve validation errors for a specific project by ID.

#### Path Parameters

| Name                                 | Type   | Description                                      |
| ------------------------------------ | ------ | ------------------------------------------------ |
| id<mark style="color:red;">\*</mark> | string | ID of the project to retrieve validation errors. |
...
{% tab title="404: Not Found Could not find an project with this ID." %}
```javascript
{
