...
<mark style="color:orange;">`PUT`</mark> `https://ris.rightsline.com/v4/project/:id/overwrite-parties`

This endpoint allows you to overwrite parties for a specific project by ID.

#### Path Parameters

| Name                                 | Type   | Description        |
| ------------------------------------ | ------ | ------------------ |
| id<mark style="color:red;">\*</mark> | number | ID of the project. |
...
{% tab title="404: Not Found Could not find a project with this ID." %}
```javascript
{
...
{% tab title="404: Not Found Selected parties not found on project." %}
```json
...
{% tab title="404: Not Found No parties exist on project." %}
```json
{
