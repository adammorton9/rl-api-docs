...
<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/project/:id/audit-history`
...
{% tabs %}
{% tab title="200 Project history retrieved successfully." %}
```javascript
{
    "totalCount": 1,
    "entries": [
...
<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/project/:id/audit-history-detail`
...
{% tabs %}
{% tab title="200 Project history details retrieved successfully." %}
```javascript
{
    "changedField": "notes",
    "oldValue": "old note",
