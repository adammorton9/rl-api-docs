...
## Get table validation errors

<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/table/:id/validation-errors`

This endpoint allows you to retrieve validation errors for a specific table by ID.

#### Path Parameters

| Name                                 | Type   | Description                                    |
| ------------------------------------ | ------ | ---------------------------------------------- |
| id<mark style="color:red;">\*</mark> | string | ID of the table to retrieve validation errors. |
...
{% tab title="404: Not Found Could not find an table with this ID." %}
```javascript
{
