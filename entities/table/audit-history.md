---
description: Retrieve the audit history for a table record.
---
...
<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/table/:id/audit-history`
...
{% tabs %}
{% tab title="200 Table history retrieved successfully." %}
```javascript
{
    "totalCount": 1,
    "entries": [
...
{% tab title="404 Could not find a table with this ID." %}
```javascript
{
...
<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/table/:id/audit-history-detail`
