...
<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/inventory/:id/validation-errors`
...
| ------------------------------------ | ------ | -------------------------------------------------- |
| id<mark style="color:red;">\*</mark> | string | ID of the inventory to retrieve validation errors. |
