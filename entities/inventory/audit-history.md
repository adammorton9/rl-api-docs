---
description: Retrieve the audit history for an inventory record.
---
...
<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/inventory/:id/audit-history`

This endpoint allows you to retrieve the audit history of a specific inventory by ID.

#### Path Parameters

| Name | Type   | Description                      |
| ---- | ------ | -------------------------------- |
| id   | string | ID of the inventory to retrieve. |
...
{% tabs %}
{% tab title="200 Inventory history retrieved successfully." %}
```javascript
{
    "totalCount": 1,
    "entries": [
...
{% tab title="404 Could not find an inventory with this ID." %}
```javascript
{
...
## Get inventory audit history details

<mark style="color:blue;">`GET`</mark> `https://ris.rightsline.com/v4/inventory/:id/audit-history-detail`
...
{% tabs %}
{% tab title="200 Inventory history details retrieved successfully." %}
```javascript
{
    "changedField": "notes",
    "oldValue": "old note",
