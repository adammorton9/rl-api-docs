...
<mark style="color:orange;">`PUT`</mark> `https://ris.rightsline.com/v4/inventory/:id/overwrite-parties`

This endpoint allows you to overwrite parties for a specific inventory by ID.

#### Path Parameters

| Name                                 | Type   | Description          |
| ------------------------------------ | ------ | -------------------- |
| id<mark style="color:red;">\*</mark> | number | ID of the inventory. |
...
{% tab title="404: Not Found Could not find an inventory with this ID." %}
```javascript
{
...
{% tab title="404: Not Found Selected parties not found on inventory." %}
```json
...
{% tab title="404: Not Found No parties exist on inventory." %}
```json
{
